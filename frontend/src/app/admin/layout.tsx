...
const NAV_ICONS: Record<string, React.ReactNode> = {
  ...
  streamers: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><polyline points="6 1 3 4"/><polyline points="10 1 7 4"/><polyline points="14 1 11 4"/><polyline points="18 1 15 4"/></svg>,
  ...
  matrix: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg>,
  roles: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>,
  plans: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>,
  badges: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>,
  professions: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>,
  ...
  economy: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>,
...
const adminNavItems = [
  {
    ...
    items: [
      ...
      { href: '/admin/settings', label: 'Configuración Global', icon: 'settings', color: '#fbbf24' },
    ],
  },
  {
    section: 'Arquitectura & Permisos',
    items: [
      { href: '/admin/permissions', label: 'Matriz de Permisos', icon: 'matrix', color: '#00e5ff' },
      { href: '/admin/roles', label: 'Constructor de Roles', icon: 'roles', color: '#ec4899' },
      { href: '/admin/plans', label: 'Planes Premium', icon: 'plans', color: '#ffd700' },
      { href: '/admin/badges', label: 'Insignias (Badges)', icon: 'badges', color: '#a78bfa' },
      { href: '/admin/professions', label: 'Profesiones Base', icon: 'professions', color: '#38bdf8' },
    ],
  },
  {
    ...
    items: [
      ...
      { href: '/admin/streamers', label: 'Streamers', icon: 'streamers', color: '#a0a0a0' },
  ...
  {
    section: 'Operaciones & Economía',
    items: [
      { href: '/admin/economy', label: 'Economía Stardust', icon: 'economy', color: '#fbbf24' },
      { href: '/admin/vtuber-requests', label: 'Solicitudes VTuber', icon: 'requests', color: '#d4af37' },
      { href: '/admin/streamer-requests', label: 'Solicitudes Streamer', icon: 'requests', color: '#00e5ff' },
      ...
      { href: '/admin/stickers', label: 'Stickers & Emojis', icon: 'stickers', color: '#34d399' },
    ],
  },
  {
    section: 'Contenido',
    items: [
      { href: '/admin/news', label: 'Noticias & Novedades', icon: 'news', color: '#a78bfa' },
