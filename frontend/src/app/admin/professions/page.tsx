...
const DEFAULT_PROFESSIONS: ProfessionConfig[] = [
  ...
  { id: 'STREAMER', name: 'Streamer', category: 'Creador Live', color: '#38bdf8', description: 'Creadores de contenido en directo con perfil propio y monitoreo live', hasDedicatedPage: true, dedicatedPagePath: '/streamers', allowTips: true, allowLiveAlerts: true, allowPortfolios: false, allowClips: true },
