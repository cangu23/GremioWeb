...
import { StreamerProfile, STREAMER_SURVEY_QUESTIONS, type SurveyAnswers, hasAnyRole } from '@gremio-estelar/shared';
...
function StreamerProfileEditor() {
  ...
  useEffect(() => {
    if (!isLoading && !user) {
      router.push('/login');
    } else if (user && (user as any).streamerProfile) {
      const p = (user as any).streamerProfile as StreamerProfile;
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast('Perfil Streamer actualizado', 'success');
  ...
  // ── Guard: solo streamers oficiales pueden editar su perfil ──────────
  const isOfficialStreamer =
    hasAnyRole(user.role, ['STREAMER', 'MAID', 'ADMIN', 'MODERATOR', 'STAFF', 'MOD', 'OWNER']) ||
    (user as any).streamerProfile?.isApproved === true;
    ...
    {isOfficialStreamer ? (
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
            Personaliza tu canal, horarios y cómo te ve la comunidad
          </p>
        </div>
      ...
      {showPreview ? (
        <div style={{ marginBottom: '32px' }}>
          <div style={{
            ...
            color: '#22d3ee', fontSize: '0.9rem', fontWeight: 600,
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: avatarUrl ? 'transparent' : 'linear-gradient(135deg, #0891b2, #7c3aed)',
          ...
          <div className="glass" style={{
            ...
            {fanName && (
              <span style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
                Fans: <strong style={{ color: '#22d3ee' }}>{fanName}</strong>
              </span>
            )}
          </div>
        ...
        <div className="glass" style={{ padding: '24px', marginBottom: '20px', borderRadius: '16px' }}>
          ...
          <div style={{
            ...
            background: bannerUrl
              ? `url(${bannerUrl}) center/cover`
              : 'linear-gradient(135deg, #082f49, #155e75, #082f49)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <div className="glass" style={{ padding: '24px', marginBottom: '20px', borderRadius: '16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px', marginBottom: '14px' }}>
            <div className="form-group" style={{ marginBottom: 0 }}>
              <label className="form-label">Nombre de Streamer</label>
              <div style={{ position: 'relative' }}>
                <input className="input" value={displayName} onChange={e => setDisplayName(e.target.value)}
                  placeholder="Ej: StarKeeper" />
              </div>
            </div>
            <div className="form-group" style={{ marginBottom: 0 }}>
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <div style={{ position: 'relative' }}>
                <input className="input" value={oshiMark} onChange={e => setOshiMark(e.target.value)}
                  placeholder="Oshi mark (ej: 🎙️)" maxLength={20} />
              </div>
              ...
              <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', marginTop: '8px' }}>
                {['🎙️', '🎮', '👑', '🐉', '🦊', '🐱', '🌌', '💎', '🍓', '⚡', '🌙', '🎀', '🎤', '💫', '🔮'].map(emoji => (
                  <button
                    ...
                    style={{
                      border: 'none', background: oshiMark === emoji ? 'rgba(34,211,238,0.3)' : 'rgba(255,255,255,0.05)',
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <div style={{ position: 'relative' }}>
                <input className="input" value={contentType} onChange={e => setContentType(e.target.value)}
                  placeholder="Ej: Gaming, Just Chatting" />
              </div>
            </div>
            <div className="form-group" style={{ marginBottom: 0 }}>
              <label className="form-label">
          ...
          <div className="form-group">
            ...
            <textarea className="input" value={lore} onChange={e => setLore(e.target.value)}
              placeholder="Cuenta la historia de tu canal... ¿Cómo empezaste? ¿Cuál es tu misión?"
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: streamSchedule === preset ? 'rgba(34,211,238,0.15)' : 'rgba(255,255,255,0.03)',
                      color: streamSchedule === preset ? '#22d3ee' : 'var(--text-muted)',
                      fontSize: '0.75rem',
                      fontWeight: 600,
                      cursor: 'pointer',
                      transition: 'all 0.15s',
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input className="input" value={hashtagsInput} onChange={e => setHashtagsInput(e.target.value)}
                placeholder="streamer, español, gaming" />
              <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', marginTop: '2px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
          ...
          {/* Streamer approved badge */}
          {(user as any).streamerProfile?.isApproved && hasAnyRole(user.role, ['STREAMER']) && (
            <div
              className="glass"
              style={{
      ...
      <div className="container" style={{
        ...
        <p style={{
          ...
          Esta sección es exclusiva para streamers oficiales del gremio.
          Si transmites contenido y quieres unirte al grupo,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center' }}>
          ...
          >
            Solicitar ser Streamer Oficial
          </button>
      ...
      {/* ===== SURVEY MODAL (available for both streamers and applicants) ===== */}
      {showSurvey && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: '20px' }}>
          <div className="glass" style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <div>
                <h2 style={{ fontSize: '1.3rem', fontWeight: 700 }}>Cuestionario Streamer</h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '18px', marginBottom: '24px' }}>
              {STREAMER_SURVEY_QUESTIONS.map((q) => (
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
              ...
              <button
                onClick={async () => {
                  ...
                  const missing = STREAMER_SURVEY_QUESTIONS
                  ...
                  try {
                    await apiFetch('/streamers/request', {
                      method: 'POST',
                      body: JSON.stringify({
                        type: 'STREAMER',
      ...
      <ImageCropperModal
        ...
        title={cropperType === 'avatar' ? 'Editar Foto de Perfil' : 'Editar Banner de Streamer'}
