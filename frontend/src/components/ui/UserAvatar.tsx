  ...
  const avatarContent = (
    <>
      ...
      {activeFrameUrl ? (
        ...
        // El usuario puede ocultarlo desde el inventario (profileFrame === 'OFF').
        const planUser = isSelf ? (currentUser as any) : user;
        const planBorder = planUser?.profileFrame === 'OFF'
          ? null
          : getPlanAvatarBorder(planUser?.plan, planUser?.role);
