    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: '24px',
          padding: '28px',
          background: 'linear-gradient(135deg, rgba(25, 20, 45, 0.95), rgba(15, 12, 30, 0.98))',
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#fff', margin: 0 }}>
            Solicitar Mascota Acompañante
          </h2>
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginTop: '6px' }}>
            Envía tu solicitud y los administradores crearán 1 o 2 imágenes/GIFs personalizados para acompañarte en tu perfil.
          </p>
        </div>
        ...
        {myRequests.length > 0 && (
          <div style={{ marginTop: '24px', borderTop: '1px solid rgba(255, 255, 255, 0.1)', paddingTop: '16px' }}>
            <h4 style={{ fontSize: '0.95rem', fontWeight: 800, color: '#fff', marginBottom: '12px' }}>
              📜 Mis Solicitudes
            </h4>
